...
class PiutangAfterExportController extends Controller
{
    public function printPdf(Request $request)
    {
        ...
        try {
            ...
            $items = $apiService->fetchPiutangAfterData();
        } catch (\Exception $e) {
            $items = [];
        }
        ...
        $pdf = Pdf::loadView('exports.piutang-after-pdf', [
            'items' => $filteredItems,
        ...
        return $pdf->stream('Laporan_Piutang_After_' . now()->format('YmdHis') . '.pdf');
    }
}

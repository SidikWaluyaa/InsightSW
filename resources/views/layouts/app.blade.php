        ...
        <div class="min-h-screen bg-gray-50 dark:bg-gray-950 transition-colors duration-300" x-data="{ open: true, mobileOpen: false }">
            ...
            <aside 
                ...
                <nav class="relative flex-1 px-3 py-4 space-y-1 overflow-y-auto">
                    ...
                    {{-- Dashboard Analysis (External Link) --}}
                    <div class="space-y-1 mb-4">
                        <a href="https://dashboardsw.shoeworkshop.id/" target="_blank"
                            class="w-full flex items-center justify-between px-3 py-2.5 rounded-xl text-[13px] font-bold transition-all duration-200 text-slate-400 hover:text-white hover:bg-white/5 border border-transparent group">
                            <div class="flex items-center gap-3">
                                <div class="w-8 h-8 rounded-lg bg-indigo-500/10 flex items-center justify-center text-indigo-400 group-hover:bg-indigo-500/20 transition-colors">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                                    </svg>
                                </div>
                                <span x-show="open" x-transition class="uppercase tracking-widest text-[11px] font-black">Dashboard Analysis</span>
                            </div>
                            <svg x-show="open" class="w-3 h-3 text-slate-600 group-hover:text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" /></svg>
                        </a>
                    </div>
                    ...
                    @php
                        $csSubItems = [
                            ...
                            ['route' => 'cs-kpi', 'label' => 'KPI CS', 'icon' => '...'],
                            ['route' => 'cs-forecasting', 'label' => 'Forecasting CS', 'icon' => '...'],
                        ...
                        $isCsActive = request()->routeIs(['cs-dashboard', 'cs-kpi', 'cs-forecasting', 'chat-masuk', 'cs-followup', 'cs-tracking']);
                    @endphp

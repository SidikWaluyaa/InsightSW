...
<head>
    ...
    <style>
        ...
        th { background-color: #6366f1; color: white; font-weight: bold; text-transform: uppercase; font-size: 8px; }
        .text-right { text-align: right; }
        .text-center { text-align: center; }
        .header { margin-bottom: 20px; text-align: center; border-bottom: 2px solid #6366f1; padding-bottom: 10px; }
        ...
        .summary-row { background-color: #f5f3ff; }
        ...
        .spk-num { font-weight: bold; font-family: monospace; font-size: 10px; color: #6366f1; }
    </style>
</head>
<body>
    <div class="header">
        <h1>Laporan Data QC (Quality Control)</h1>
        <p>
            Dicetak pada: {{ now()->format('d/m/Y H:i') }} |
            Total Di QC: {{ $totalDiQc }} |
        ...
        <tbody>
            @forelse($items as $item)
                ...
                <tr>
                    ...
                    {{-- WAKTU MASUK QC --}}
                    <td>
                        <div>{{ $item['entered_qc_at_formatted'] ?: '-' }}</div>
                        <div style="font-size: 8px; color: #6366f1; margin-top: 2px;">{{ $item['days_in_qc'] ?? 0 }} Hari di QC</div>
                    </td>
    ...
    <table style="margin-top: 15px; width: 40%; margin-left: auto;">
        <tr class="summary-row">
            ...
            <td class="text-right" style="font-family: monospace; color: #6366f1; font-size: 12px;">{{ $totalDiQc }}</td>
        </tr>
        <tr class="summary-row">

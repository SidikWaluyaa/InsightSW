            ...
            <div class="bg-white dark:bg-gray-900 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-800 overflow-hidden">
                <div class="p-8 border-b border-gray-100 dark:border-gray-800 flex flex-col md:flex-row md:items-center justify-between gap-4 bg-indigo-50/30 dark:bg-indigo-900/10">
                    ...
                    <div class="flex flex-col xl:flex-row items-start xl:items-center gap-4">
                        ...
                        <div class="flex items-center p-1 bg-white/50 dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 flex-wrap gap-1">
                            <button wire:click="$set('typeFilter', 'all')" 
                                class="px-3 py-1.5 rounded-lg text-[10px] font-bold transition-all {{ $typeFilter === 'all' ? 'bg-slate-600 text-white shadow-md' : 'text-slate-500 hover:bg-slate-100 dark:hover:bg-gray-700' }}">
                                SEMUA
                            </button>
                            <button wire:click="$set('typeFilter', 'BEFORE')" 
                                class="px-3 py-1.5 rounded-lg text-[10px] font-bold transition-all {{ $typeFilter === 'BEFORE' ? 'bg-emerald-500 text-white shadow-md' : 'text-emerald-600 hover:bg-emerald-50 dark:hover:bg-emerald-900/20' }}">
                                DP / AWAL
                            </button>
                            <button wire:click="$set('typeFilter', 'AFTER')" 
                                class="px-3 py-1.5 rounded-lg text-[10px] font-bold transition-all {{ $typeFilter === 'AFTER' ? 'bg-blue-500 text-white shadow-md' : 'text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/20' }}">
                                LUNAS / AKHIR
                            </button>
                            <button wire:click="$set('typeFilter', 'TAMBAH_JASA')" 
                                class="px-3 py-1.5 rounded-lg text-[10px] font-bold transition-all {{ $typeFilter === 'TAMBAH_JASA' ? 'bg-indigo-500 text-white shadow-md' : 'text-indigo-600 hover:bg-indigo-50 dark:hover:bg-indigo-900/20' }}">
                                TAMBAH JASA
                            </button>
                            <button wire:click="$set('typeFilter', 'LUNAS_AWAL')" 
                                class="px-3 py-1.5 rounded-lg text-[10px] font-bold transition-all {{ $typeFilter === 'LUNAS_AWAL' ? 'bg-amber-500 text-white shadow-md' : 'text-amber-600 hover:bg-amber-50 dark:hover:bg-amber-900/20' }}">
                                LUNAS AWAL
                            </button>
                            <button wire:click="$set('typeFilter', 'ONGKIR')" 
                                class="px-3 py-1.5 rounded-lg text-[10px] font-bold transition-all {{ $typeFilter === 'ONGKIR' ? 'bg-rose-500 text-white shadow-md' : 'text-rose-600 hover:bg-rose-50 dark:hover:bg-rose-900/20' }}">
                                ONGKIR
                            </button>
                        </div>
                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-800 uppercase text-[11px] font-bold">
                            ...
                            <tr class="hover:bg-slate-50 dark:hover:bg-gray-800/30 transition-colors">
                                ...
                                <td class="px-8 py-5">
                                    <span class="px-2 py-0.5 rounded text-[9px] font-bold uppercase {{ $payment->payment_type_badge_class }}">
